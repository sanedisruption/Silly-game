    ...
    void cell()
    {
        text.text = "You are in a prison cell, and you want ot escape. There are " +
    ...
    void cell_mirror()
    {
        text.text = "You are still in your cell, and you STILL want to escape! There " +
                    ...
                    "and that pesky lock still firmly hold the door closed!\n\n" +
    ...
    void lock_1()
    {
        text.text = "You carefully put the mirror through the bars, and turn it " +
                    "around so you can see the lock. You can just make out the " +
    ...
    void corridor_0()
    {
        text.text = "You're out of your cell, but not out of trouble. You are in the " +
                    "corridor, there's a closet and some stairs leading to the courtyard. " +
                    "There's also various objects scattered on the floor\n\n" +
    ...
    void corridor_1()
    {
        text.text = "Still in the corridor. Floor's still dirty. Hairclip in hand. Now " +
                    "what? You wonder if that lock on the closet would succumb to some " +
                    "lock-picking?\n\n" +
    ...
    void corridor_3()
    {
        text.text = "You're standing back in the corridor, now convincingly dressed " +
                    "as a cleaner.\n\n" +
    ...
    void stairs_0()
    {
        text.text = "You start walking up the stairs towards the outside light. You " +
                    "realize it's not break time, and you'll be caught immediately. " +
    ...
    void stairs_2()
    {
        text.text = "You feel smug for picking hte closet door open, and are still " +
                    "armed with a hairclip (now badly bent). Even these achievements " +
                    "together don't give you the courage to climb up the stairs to your " +
                    "death!\n\n" +
                    "Press R to return to the corridor";
    ...
    void closet_door()
    {
        text.text = "You are looking at a closet door, unfortunately it's locked. " +
                    "Maybe you could find something around to help encourage it to " +
                    "open?\n\n" +
                    "Press R to Return to the corridor";
        if          (Input.GetKeyDown(KeyCode.R))   {myState = States.corridor_0;}
    }
    void in_closet()
    {
        text.text = "Inside the closet you see a cleaner's uniform that looks about " +
                    "your size! Seems like your day is shaping up.\n\n" +
    ...
    void courtyard()
    {
        text.text = "You walk through the courtyard dressed as a cleaner. The guard " +
                    "tips his hat at you as you waltz past, claiming your freedom. " +
                    "Your heart races as you walk into the sunset.\n\n" +
